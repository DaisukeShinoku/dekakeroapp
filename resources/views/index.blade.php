...
@section('contets')
    <section class="mt-10">
        ...
        @csrf
            ...
            <button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">ログイン</button>
        </form>
        <br>
        <br>
        <hr>
        ...
        <form class="flex flex-col" action="/login" method="post">
            ...
            <button class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200 w-full" type="submit">
                ゲストユーザーでログイン
            </button>
        </form>
        <br>
